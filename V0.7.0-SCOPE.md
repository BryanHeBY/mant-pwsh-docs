...
Version 0.7.0 is the first publishable English reference release. It provides a
...
is [`release/v0.7.0.json`](release/v0.7.0.json).
...
The `v0.7.0` tag may be created only when:
...
## Deferred from version 0.7.0

Version 0.7.0 does not duplicate upstream pages one-for-one. The Windows tool
