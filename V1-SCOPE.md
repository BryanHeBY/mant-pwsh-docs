...
| `pwsh-cli` | 97 | Native tools frequently called from PowerShell, including Windows shell/GUI/registry entry points, batch/file, directory, link, text, process, host, network, installation, image-servicing, driver, security-policy and authentication operations, file associations, winget, and optional Microsoft Learn MCP discovery. |
| **Total** | **157** | Current first-release document inventory. |
...
- all 157 manifest documents exist and pass portable validation;
