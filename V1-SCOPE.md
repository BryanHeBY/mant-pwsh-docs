...
| `pwsh-cli` | 93 | Native tools frequently called from PowerShell, including Windows shell/GUI/registry entry points, batch/file, directory, link, text, process, host, network, installation, image-servicing, and driver operations, file associations, winget, and optional Microsoft Learn MCP discovery. |
| **Total** | **153** | Current first-release document inventory. |
...
- all 153 manifest documents exist and pass portable validation;
