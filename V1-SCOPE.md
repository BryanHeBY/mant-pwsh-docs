...
| `pwsh-cli` | 88 | Native tools frequently called from PowerShell, including Windows shell/GUI/registry entry points, batch/file, directory, link, text, process, host and network-diagnostic operations, file associations, winget, and optional Microsoft Learn MCP discovery. |
| **Total** | **148** | Current first-release document inventory. |
...
- all 148 manifest documents exist and pass portable validation;
