...
| `windows-tools` | 317 | Windows-native and optional executables, Cmd builtins and interactive families, shell/GUI/URI entry points, package and system management, diagnostics, server roles, compatibility and recovery utilities, and optional Microsoft Learn MCP discovery. |
| `cross-platform-tools` | 6 | A dedicated index plus Git, OpenSSH, curl, tar, and .NET CLI guidance for Windows, macOS, and Linux. |
| **Total** | **383** | Current first-release document inventory. |
...
- all 383 manifest documents exist and pass portable validation;
