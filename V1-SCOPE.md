...
| `pwsh-cli` | 48 | Native tools frequently called from PowerShell, including Windows shell/GUI/registry entry points, batch/file operations, file associations, winget, and optional Microsoft Learn MCP discovery. |
| **Total** | **108** | Current first-release document inventory. |
...
- all 108 manifest documents exist and pass portable validation;
