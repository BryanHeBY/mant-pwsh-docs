...
| `pwsh-cli` | 61 | Native tools frequently called from PowerShell, including Windows shell/GUI/registry entry points, batch/file, directory and text operations, file associations, winget, and optional Microsoft Learn MCP discovery. |
| **Total** | **121** | Current first-release document inventory. |
...
- all 121 manifest documents exist and pass portable validation;
