...
| `pwsh-cli` | 83 | Native tools frequently called from PowerShell, including Windows shell/GUI/registry entry points, batch/file, directory, link, text, process, host and network-diagnostic operations, file associations, winget, and optional Microsoft Learn MCP discovery. |
| **Total** | **143** | Current first-release document inventory. |
...
- all 143 manifest documents exist and pass portable validation;
