...
| `pwsh-cli` | 73 | Native tools frequently called from PowerShell, including Windows shell/GUI/registry entry points, batch/file, directory, link, text, process and host operations, file associations, winget, and optional Microsoft Learn MCP discovery. |
| **Total** | **133** | Current first-release document inventory. |
...
- all 133 manifest documents exist and pass portable validation;
