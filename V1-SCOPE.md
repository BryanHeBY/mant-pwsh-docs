...
| `pwsh-cli` | 42 | Native tools frequently called from PowerShell, including Windows shell/GUI/registry entry points, batch control, file associations, winget, and optional Microsoft Learn MCP discovery. |
| **Total** | **102** | Current first-release document inventory. |
...
- all 102 manifest documents exist and pass portable validation;
