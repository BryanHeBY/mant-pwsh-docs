...
| `pwsh-cli` | 55 | Native tools frequently called from PowerShell, including Windows shell/GUI/registry entry points, batch/file and directory operations, file associations, winget, and optional Microsoft Learn MCP discovery. |
| **Total** | **115** | Current first-release document inventory. |
...
- all 115 manifest documents exist and pass portable validation;
