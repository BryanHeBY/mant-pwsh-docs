...
| `pwsh-cli` | 67 | Native tools frequently called from PowerShell, including Windows shell/GUI/registry entry points, batch/file, directory, link and text operations, file associations, winget, and optional Microsoft Learn MCP discovery. |
| **Total** | **127** | Current first-release document inventory. |
...
- all 127 manifest documents exist and pass portable validation;
