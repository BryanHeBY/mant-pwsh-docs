...
| `pwsh-cli` | 79 | Native tools frequently called from PowerShell, including Windows shell/GUI/registry entry points, batch/file, directory, link, text, process, host and network-diagnostic operations, file associations, winget, and optional Microsoft Learn MCP discovery. |
| **Total** | **139** | Current first-release document inventory. |
...
- all 139 manifest documents exist and pass portable validation;
