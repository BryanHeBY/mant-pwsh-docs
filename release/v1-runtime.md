...
Get-Command taskmgr.exe, resmon.exe, winver.exe, mrt.exe, msra.exe, eventvwr.exe, mmc.exe -All
...
Get-Item "$env:SystemRoot\System32\comexp.msc", "$env:SystemRoot\System32\wmimgmt.msc", "$env:SystemRoot\System32\printmanagement.msc" -ErrorAction SilentlyContinue
