# Version 0.6.0 runtime verification

This checklist records the runtime evidence required by
[V0.6.0-SCOPE.md](../V0.6.0-SCOPE.md) before creating the final `v0.6.0` tag. It is separate
...
environmental exception and decide whether the 0.6.0 scope or test host must
change.
