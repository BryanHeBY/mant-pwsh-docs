...
`v0.6.0.json` is the authoritative inventory for the initial English 0.6.0
...
[v0.6.0-runtime.md](v0.6.0-runtime.md) is the required platform verification
matrix. [v0.6.0-runtime-evidence.md](v0.6.0-runtime-evidence.md) records
